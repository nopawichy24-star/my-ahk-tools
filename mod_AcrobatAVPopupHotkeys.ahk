...
;     เริ่มที่ false)
;   กด 2 ครั้งติดกันเร็ว ๆ = พิมพ์เฉพาะหน้าปัจจุบันทันที (ผ่าน Ctrl+P + Alt+U อัตโนมัติ - ดู
;     รายละเอียดที่ SC019_DoPrint) แต่ทำได้ก็ต่อเมื่อ g_SC019_PrintArmed เป็น ON (true) อยู่
;     ตอนนั้นเท่านั้น ถ้าสถานะเป็น OFF การกด 2 ครั้งจะไม่พิมพ์ - ทำเหมือนพิมพ์ตัวอักษร p ปกติ 2 ตัวแทน
...
;
; สั่งพิมพ์ผ่านคีย์ลัด Ctrl+P แล้ว Alt+U เลือก "พิมพ์เฉพาะหน้าปัจจุบัน" แล้ว Enter ยืนยัน
; (ไม่ใช้ COM/AcroExch.App แบบที่เคยลองมาก่อน เพราะ Adobe Reader ตัวฟรีบล็อกปิดกั้น COM
; automation ของโปรแกรมภายนอกไว้ - ยืนยันแล้วว่าเป็นสาเหตุจริงของ error 0x800401E3 ที่เจอ)
; =========================================================
