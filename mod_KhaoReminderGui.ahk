...
KhaoRem_Init() {
    KhaoRem_LoadItems()
    ; เช็คทุกวินาที ไม่ใช่ทุก 30 วิ - การเช็คนี้แค่วนลูป array ในหน่วยความจำ ไม่ได้อ่าน/เขียนไฟล์
    ; ทุกครั้ง (เขียนไฟล์แค่ตอนมีรายการถึงเวลาเตือนจริง ๆ) ต้นทุนการเช็คถี่ขึ้นจึงแทบเป็นศูนย์
    ; แต่ทำให้แจ้งเตือนตรงเวลาจริง แทนที่จะช้าไปได้สูงสุดเกือบ 30 วิเหมือนเดิม
    SetTimer(KhaoRem_CheckDueItems, 1000)
}
