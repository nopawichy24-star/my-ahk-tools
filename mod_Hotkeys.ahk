...
;
; ค่าดีเลย์ F6_DoublePressMs ย้ายไปรวมไว้ที่ mod_HotkeyTiming.ahk แล้ว (พร้อมเหตุผลการเทียบ
; ความเร็วกับปุ่มอื่นที่มี 1/2/3 ครั้งในปุ่มเดียวกันทั้งหมดในโปรเจกต์)
...
; ค่าดีเลย์ F10_DoublePressMs ย้ายไปรวมไว้ที่ mod_HotkeyTiming.ahk แล้ว
...
; หน้าต่าง Notepad ทุกบานพร้อมกันเป็นกลุ่มเดียว (เช่น ถ้าผู้ใช้เปิด Notepad เพิ่มเองอีกบานนอกจาก
...
;
; ค่าดีเลย์ SC070_DoublePressMs ย้ายไปรวมไว้ที่ mod_HotkeyTiming.ahk แล้ว
; ===============================
